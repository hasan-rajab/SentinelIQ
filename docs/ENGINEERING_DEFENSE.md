# Engineering Defense — SentinelIQ

This drill is intentionally adversarial. It is designed to make the project defensible in a forward-deployed engineering interview without overstating portfolio-scale evidence as production deployment.
